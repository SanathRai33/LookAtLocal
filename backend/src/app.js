...
const rentalBookingRoutes = require("./modules/rental-booking/rental-booking.routes");
const productRoutes = require("./modules/product/product.routes");
const productBookingRoutes = require("./modules/product-booking/product-booking.routes");
...
app.use("/api/v1/rental-bookings", rentalBookingRoutes);
app.use("/api/v1/products", productRoutes);
app.use("/api/v1/product-bookings", productBookingRoutes);
