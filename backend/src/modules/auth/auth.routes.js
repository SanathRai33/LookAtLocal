...
const { registerSchema, loginSchema, changePasswordSchema, forgotPasswordSchema, resetPasswordSchema, verifyEmailSchema } = require("./auth.validation");

const { register, login, getMe, refreshToken, logout, changePassword, forgotPassword, resetPassword, sendVerificationEmail, verifyEmail } = require("./auth.controller");
