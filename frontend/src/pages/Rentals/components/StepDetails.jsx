    ...
    return (
        <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Provide detailed information about your rental item
            </p>
            ...
            <div className="mt-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Describe your item, condition, features, and rental terms..."
                        rows="5"
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className={`w-full h-[42px] rounded-2xl border bg-gray-50 px-4 text-base text-gray-900 outline-none transition focus:bg-white focus:ring-4 disabled:opacity-60 dark:bg-slate-900 dark:text-white ${errors.condition
                                    ? 'border-red-500 focus:border-red-500 focus:ring-red-500/10'
                                    : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500/10 dark:border-slate-700'
                                }`}
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="e.g. 2"
                            className={`w-full h-[42px] rounded-2xl border bg-gray-50 px-4 text-base text-gray-900 outline-none transition placeholder:text-gray-500 focus:bg-white focus:ring-4 disabled:opacity-60 dark:bg-slate-900 dark:text-white ${errors.quantity
                                    ? 'border-red-500 focus:border-red-500 focus:ring-red-500/10'
                                    : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500/10 dark:border-slate-700'
                                }`}
                        />
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={handleChange}
                        className={`w-full h-[42px] rounded-2xl border bg-gray-50 px-4 text-base text-gray-900 outline-none transition focus:bg-white focus:ring-4 disabled:opacity-60 dark:bg-slate-900 dark:text-white ${errors.deliveryOption
                                ? 'border-red-500 focus:border-red-500 focus:ring-red-500/10'
                                : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500/10 dark:border-slate-700'
                            }`}
                    >
                    ...
                    {errors.deliveryOption && (
                        <p className="mt-1 text-sm text-red-500">{errors.deliveryOption}</p>
                    )}
                </div>
