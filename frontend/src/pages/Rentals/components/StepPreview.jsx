...
import { MapPin, IndianRupee, Clock, AlertCircle, Loader2, Shield } from 'lucide-react';
...
const StepPreview = ({ formData, onPrev, onSubmit, loading, error }) => {
    const getCategoryName = () => {
        ...
        return formData.categoryId || 'Rental';
    };
    ...
    return (
        <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Review your rental listing details before submitting
            </p>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap items-center gap-3 mt-2 text-xs text-gray-500 dark:text-gray-400">
                                <span>Quantity: {formData.quantity || 1}</span>
                                <span>•</span>
                                <span>Delivery: {getDeliveryLabel(formData.deliveryOption)}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-4 border-t border-gray-100 bg-gray-50 dark:border-slate-800 dark:bg-slate-800/50">
                    <div className="flex items-start gap-3 text-sm">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                            Your rental listing will be reviewed and published within 24 hours. You'll receive a notification when it's live.
                        </p>
                    </div>
                </div>
            </div>
