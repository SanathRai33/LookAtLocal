  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
        Set the salary range and location details
      </p>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full h-[42px] rounded-2xl border border-gray-300 bg-gray-50 px-4 text-base text-gray-900 outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 disabled:opacity-60 dark:border-slate-700 dark:bg-slate-900 dark:text-white"
            >
