...
import { MapPin, IndianRupee, Clock, AlertCircle, Loader2 } from 'lucide-react';
...
const StepPreview = ({ formData, onPrev, onSubmit, loading, error }) => {
  const getCategoryName = () => {
    ...
    return categories[formData.categoryId] || formData.categoryId || 'Service';
  };
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-4 text-sm text-gray-500 dark:text-gray-400">
                ...
                <span className="flex items-center gap-1 font-semibold text-gray-950 dark:text-white">
                  ...
                  {formData.price || '0'}/{getPricingLabel(formData.pricingType)}
                </span>
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50 dark:border-slate-800 dark:bg-slate-800/50">
          <div className="flex items-start gap-3 text-sm">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Your listing will be reviewed and published within 24 hours. You'll receive a notification when it's live.
            </p>
          </div>
        </div>
      </div>
