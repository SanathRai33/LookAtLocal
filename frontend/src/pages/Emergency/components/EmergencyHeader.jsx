...
import { Search, SlidersHorizontal, ChevronDown, Plus, AlertTriangle } from 'lucide-react';
...
const EmergencyHeader = ({
    ...
    return (
        <div className="mb-8">
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between lg:flex-col lg:items-start">
                ...
                <div className="flex flex-col w-full gap-3 sm:flex-row md:w-auto lg:self-end">
                    ...
                    <Link
                        to="/emergency/create"
                        className="flex items-center justify-center gap-2 px-5 py-2.5 font-medium text-white transition-all duration-200 bg-red-600 hover:bg-red-700 rounded-xl hover:shadow-lg hover:shadow-red-500/25 whitespace-nowrap"
                    >
