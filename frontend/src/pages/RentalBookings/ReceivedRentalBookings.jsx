...
import ReceivedRentalBookingCard from "./components/ReceivedRentalBookingCard";
import { useSearchParams } from "react-router-dom";

const ReceivedRentalBookings = () => {
    const {
        bookings,
        pagination,
        loading,
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                                Received Rental Bookings
                            </h1>

                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                Manage rental requests from customers.
                            </p>
                        </div>
                    </div>
                ...
                {loading && bookings.length === 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center px-6 py-20 mt-8 text-center bg-white border border-gray-200 rounded-2xl dark:border-slate-700 dark:bg-slate-800">
                        ...
                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            Rental requests received for your listings
                            will appear here.
                        </p>
                    </div>
                ) : (
...
export default ReceivedRentalBookings;