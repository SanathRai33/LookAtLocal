    ...
    return (
        <article className="flex flex-col h-full overflow-hidden bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-slate-700 dark:bg-slate-800">
            <div className="flex flex-col flex-1 p-5 sm:p-6">
                ...
                {seller.fullName && (
                    <div className="flex items-center gap-3 p-4 mt-5 rounded-xl bg-gray-50 dark:bg-slate-700/50">
                        <img
                            src={
                ...
                {canCancel && (
                    <div className="flex justify-end pt-5 mt-5 border-t border-gray-200 dark:border-slate-700">
                        <button
                            type="button"
                            onClick={() =>
                                onCancel(booking)
