...
const StepDetails = ({ formData, updateFormData, onNext, onPrev }) => {
  ...
  const validate = () => {
    ...
    if (!formData.spaceType) newErrors.spaceType = 'Please select space type';
  ...
  return (
    <div>
      <h2 className="text-lg font-semibold text-gray-950 dark:text-white">Space Details</h2>
      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Provide detailed information about your space</p>
      ...
      <div className="mt-6 space-y-5">
        <div>
          ...
          <input
            ...
            placeholder="e.g. Premium Office Space in Andheri"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            placeholder="Describe your space, features, and terms..."
            rows="5"
