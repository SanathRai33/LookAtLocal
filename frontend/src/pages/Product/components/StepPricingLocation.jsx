...
const StepPricingLocation = ({ formData, updateFormData, onNext, onPrev }) => {
  ...
  return (
    <div>
      <h2 className="text-lg font-semibold text-gray-950 dark:text-white">Pricing & Location</h2>
      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Set your pricing and location details</p>
      ...
      <div className="mt-6 space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <label htmlFor="isNegotiable" className="text-sm text-gray-700 dark:text-gray-300">Price is negotiable</label>
        </div>
