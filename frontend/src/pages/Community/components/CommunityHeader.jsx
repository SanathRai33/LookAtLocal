...
import { Search, SlidersHorizontal, ChevronDown, Plus, Users } from 'lucide-react';
  ...
  return (
    <div className="mb-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 md:text-base">
            Connect and share with your neighbourhood
            {/* Connect, share, and stay updated with your neighbourhood */}
          </p>
        </div>
        <div className="flex flex-col w-full gap-3 sm:flex-row md:w-auto">
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium transition rounded-xl whitespace-nowrap ${
              isMine
      ...
      <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">
        {loading ? 'Loading...' : `${totalCount} posts found`}
      </div>
    </div>
  );
};
